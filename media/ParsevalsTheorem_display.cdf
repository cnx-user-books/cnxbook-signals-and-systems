...
NotebookOptionsPosition[      5927,        160]
NotebookOutlinePosition[      6284,        176]
CellTagsIndexPosition[      6241,        173]
WindowFrame->Normal*)
         ...
         ListLinePlot[
          Table[
           ...
           UnitBox[$CellContext`a $CellContext`time], {$CellContext`time, -11,
             11, 0.1}], AxesOrigin -> {0, 0}, DataRange -> {-11, 11}, 
...
$CellContext`freq], {$CellContext`freq, -11, 11, 0.1}], AxesOrigin -> {0, 0}, 
...
{$CellContext`time, -11, 11, 0.01}]], 4]]}, ImageSize -> {200, 40}]], 
 ...
 CellChangeTimes->{{3.520707056477518*^9, 3.520707205851416*^9}, {
   ...
   3.52200351985686*^9, 3.5220035352871447`*^9}}]
},
WindowSize->{936, 658},
WindowMargins->{{126, Automatic}, {Automatic, 36}},
...
(*NotebookFileOutline
Notebook[{
Cell[550, 20, 5373, 138, 632, "PluginEmbeddedContent"]
}
]
*)
...
(* NotebookSignature IvTWrCnYazrqPBwvzoxX1tmf *)
