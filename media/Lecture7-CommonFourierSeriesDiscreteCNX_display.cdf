...
NotebookDataLength[     11776,        281]
NotebookOptionsPosition[     11496,        267]
NotebookOutlinePosition[     11852,        283]
CellTagsIndexPosition[     11809,        280]
WindowFrame->Normal*)
   ...
   DynamicModuleBox[{$CellContext`f$$ = {
    ...
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
      ...
      Hold[
       Dynamic[
        Row[{
          Style["# of Discrete Points"], 
          Slider[
           Dynamic[$CellContext`dn], {1, 74, 1}, Appearance -> "Labeled"]}]]],
       Manipulate`Dump`ThisIsNotAControl}}, Typeset`size$$ = {
    360., {110., 115.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`f$32167$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`f$$ = {
          SquareWave[$CellContext`x], 
          0, (2 (1 - (-1)^$CellContext`k)) ($CellContext`k^(-1)/Pi), 0, 0, 
          0}}, "ControllerVariables" :> {
        Hold[$CellContext`f$$, $CellContext`f$32167$$, False]}, 
      "OtherVariables" :> {
...
$CellContext`y, 1/$CellContext`dn}, Axes -> {True, True}, PlotLabel -> 
           "Fourier Approximation", PlotStyle -> {{
    ...
    Initialization:>({{$CellContext`Maxi = 3, $CellContext`x[
         ...
         1.67, $CellContext`y = 1, $CellContext`dn = 30, $CellContext`T = 
 ...
 CellChangeTimes->{{3.519406914997102*^9, 3.519406971371451*^9}, {
   ...
   3.520943599427679*^9, 3.520943609438671*^9}, 3.52149696415205*^9, 
   3.5226118175331593`*^9, 3.522774040233786*^9}]
},
WindowSize->{1033, 756},
...
(*NotebookFileOutline
Notebook[{
Cell[550, 20, 10942, 245, 315, "PluginEmbeddedContent"]
}
]
*)
...
(* NotebookSignature dxDovHCHju1E7CKnoholQmKn *)
