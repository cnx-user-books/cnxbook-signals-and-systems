...
NotebookDataLength[      9964,        215]
NotebookOptionsPosition[      9684,        201]
NotebookOutlinePosition[     10041,        217]
CellTagsIndexPosition[      9998,        214]
WindowFrame->Normal*)
...
$CellContext`showAnswer$$ = False, $CellContext`showEquation$$ = 
    ...
    False, $CellContext`fins$153245$$ = 
    False, $CellContext`showEquation$153246$$ = 
    False, $CellContext`showAnswer$153247$$ = 
    False, $CellContext`showPlot$153248$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`fins$$ = $CellContext`Unitbox, \
$CellContext`showAnswer$$ = False, $CellContext`showEquation$$ = 
        False, $CellContext`showPlot$$ = True}, "ControllerVariables" :> {
        Hold[$CellContext`fins$$, $CellContext`fins$153245$$, False], 
        Hold[$CellContext`showEquation$$, $CellContext`showEquation$153246$$, 
         False], 
        Hold[$CellContext`showAnswer$$, $CellContext`showAnswer$153247$$, 
         False], 
        Hold[$CellContext`showPlot$$, $CellContext`showPlot$153248$$, False]},
       "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Plot[
          $CellContext`sys[$CellContext`a, $CellContext`x], {$CellContext`x, 
           0, 10}, ImageSize -> $CellContext`S, PlotStyle -> Thick, PlotLabel -> 
          Dynamic[
            If[$CellContext`showEquation$$, 
             $CellContext`sys[$CellContext`a, $CellContext`x], 
             "\[CapitalPsi][x]"]], PlotRange -> {{0, 10}, {1.2 (-6), 1.2 6}}], 
         Dynamic[$CellContext`sysequation = $CellContext`sys2[$CellContext`a, \
$CellContext`x]; If[$CellContext`showPlot$$, 
            
            Plot[$CellContext`sysequation, {$CellContext`x, 0, 10}, 
             ImageSize -> $CellContext`S, PlotStyle -> Thick, PlotLabel -> 
             Dynamic[
...
$CellContext`Unitbox, $CellContext`fins$$ == $CellContext`Gauss], 
      ...
      "Options" :> {
       TrackedSymbols :> {$CellContext`a, $CellContext`fins$$}, 
        FrameLabel -> {"", "", 
          Style["Aperiodic Drill", Large], ""}, LocalizeVariables -> True, 
        ControllerLinking -> False, Deployed -> True}, "DefaultOptions" :> {}],
     ImageSizeCache->{711., {196., 202.}},
...
$CellContext`fins$$[$CellContext`tz$]; $CellContext`sawtoothwave[
 ...
 CellChangeTimes->{{3.521382267115099*^9, 3.521382340421155*^9}, 
   ...
   3.521498884555892*^9, 3.521498903172068*^9}, 3.52218239939209*^9, 
   3.5227729784990807`*^9}]
},
WindowSize->{927, 674},
...
(*NotebookFileOutline
Notebook[{
Cell[550, 20, 9130, 179, 400, "PluginEmbeddedContent"]
}
]
*)
...
(* NotebookSignature Tw01ChcDFrOreCge2OFQmegh *)
